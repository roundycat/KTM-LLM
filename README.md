...
| 과목 | Qwen2.5 | EXAONE 3.5 | SOLAR 10.7B | Llama3.1 |
|---|---:|---:|---:|---:|
| 침구학 | +12.1 | **+18.2** | +6.1 | +3.0 |
| 본초학 | **+30.8** | 0.0 | −7.7 | +7.7 |
| 한의학 기초 | +0.9 | +6.6 | +9.4 | −5.6 |
| 부인과학 | +6.9 | 0.0 | 0.0 | 0.0 |
| 한방생리학 | −6.2 | +6.2 | 0.0 | +12.4 |
| 신경정신과학 | +6.7 | 0.0 | −13.3 | 0.0 |
| 내과학1 | −3.1 | +1.5 | +6.1 | −1.6 |
| 소아과학 | −9.5 | −4.8 | +4.8 | 0.0 |
| 한약학 응용 | −2.9 | +1.9 | −2.9 | −2.9 |

→ **침구학은 전 모델 일관 향상**, **본초학은 Qwen에서만 폭발적**(+30.8%p). 임상추론 과목(소아 등)은
대체로 무효/역효과. 즉 효과는 **과목의 용어 의존도 × 모델의 한국어 독해력**에 좌우된다.
